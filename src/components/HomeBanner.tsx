...
const HomeBanner = () => {
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            ...
            <a href="#" className="relative font-semibold text-dark-blue">
              {/* Span ini dekoratif → jangan tangkap pointer */}
        ...
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a href="#" className="text-sm/6 font-semibold text-gray-900 hover:text-dark-blue transition-colors">
      ...
      {/* BOTTOM BLUR DECOR – tidak blokir mouse */}
      <div
        aria-hidden="true"
